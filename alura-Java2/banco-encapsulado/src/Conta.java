...
public class Conta {
	...
	public Conta(int agencia, int numero) {//construtor:  oferece a possibilidade de inicializar alguns dados e receber parâmetros
			Conta.total++;
	...
	//SETTER: modifica/atribui o numero --- não precisa do "setter" de saldo porque não iremos modificar o saldo: transfere e saca já fazem esse papel.
