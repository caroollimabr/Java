...
public class GerenciadoraContasTest_Ex6 {
	...
	public void testTransfereValor_SaldoInsuficiente() {
		...
		/* ========== Verificações ========== */
		assertTrue(sucesso); //ANTES, NÃO ERA PERMITIDO QUE AS CONTAS FICASSEM NO VERMELHO, ERA assertFalse(sucesso);
		assertThat(conta01.getSaldo(), is(-100.0)); //aqui era (100), pois não ia permitir a transferência
