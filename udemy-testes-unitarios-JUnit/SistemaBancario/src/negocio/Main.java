...
public class Main {
	...
	private static void inicializaSistemaBancario() {
		...
		Cliente cliente01 = new Cliente(1, "Fulano de Tal", 31, "fulanodetal@gmail.com", conta01.getId(), true);
		Cliente cliente02 = new Cliente(2, "Sicrano Beltrano", 34, "sicranobeltrano@gmail.com", conta02.getId(), true);
