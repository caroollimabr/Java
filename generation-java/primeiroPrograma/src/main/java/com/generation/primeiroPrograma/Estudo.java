...
public class Estudo {
	    ...
	    public static void main( String[] args ) {
	    	...
	    	Scanner entrada = new Scanner(System.in); //Ler info colocada pelo usuário no console
	    	f = entrada.nextLine(); //Ler texto digitado
	    	i = entrada.nextInt(); //Ler valor do tipo inteiro (sn é uma variável)
	    	c = entrada.nextDouble(); //Ler valor do tipo double
